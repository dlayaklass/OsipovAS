...
class Developer(Employee):
    ...
    def tech_stack(self) -> list[str]:
        ...
        return self.__tech_stack.copy()  # Возвращаем копию для защиты от изменений
    ...
    def tech_stack(self, value: list[str]):
        ...
        Args:
            value: Список технологий
        
        Raises:
            ValueError: Если передан не список или список содержит не строки
        """
    ...
    def seniority_level(self, value: str):
        ...
        Args:
            value: Уровень seniority ("junior", "middle", "senior")
        
        Raises:
            ValueError: Если уровень не является допустимым значением
        """
    ...
    def add_skill(self, new_skill: str) -> None:
        ...
        Raises:
            ValueError: Если передан не строковый тип или пустая строка
        """
    ...
    def calculate_salary(self) -> float:
        ...
        Формула: базовая_зарплата * коэффициент_уровня
        
        Returns:
            Итоговая заработная плата разработчика
        """
    ...
    def get_info(self) -> str:
        ...
        Returns:
            Строка с полной информацией о разработчике, включая уровень и стек технологий
        """
    ...
    def __iter__(self):
        ...
        Позволяет итерироваться по технологиям: for skill in developer
        """
