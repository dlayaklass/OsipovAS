...
class Salesperson(Employee):
    ...
    def commission_rate(self, value: float):
        ...
        Args:
            value: Процент комиссии (от 0 до 1)
        
        Raises:
            ValueError: Если процент комиссии не в допустимом диапазоне
        """
    ...
    def sales_volume(self, value: float):
        ...
        Raises:
            ValueError: Если объем продаж не является неотрицательным числом
        """
        if not isinstance(value, (int, float)):
    ...
    def update_sales(self, new_sales: float) -> None:
        ...
        Args:
            new_sales: Сумма новых продаж для добавления
        
        Raises:
            ValueError: Если переданная сумма не является неотрицательным числом
        """
    ...
    def calculate_salary(self) -> float:
        ...
        Формула: базовая_зарплата + (объем_продаж * процент_комиссии)
        
        Returns:
            Итоговая заработная плата продавца
        """
    ...
    def get_info(self) -> str:
        ...
        Returns:
            Строка с полной информацией о продавце, включая процент комиссии и объем продаж
        """
